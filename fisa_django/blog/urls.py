...
urlpatterns = [
    ...
    path('post_list', views.PostList.as_view(paginate_by=5), name='post_list'), # name = 개발자가 이 주소를 부를 이름. 
    ...
    # update와 create의 차이 // update, delete는 이미 있는 글을 수정/삭제하므로 글번호가 필요합니다.
    ...
    path('tag/<str:slug>/', views.tag_posts, name="tag"), #<자료명:필드명>
